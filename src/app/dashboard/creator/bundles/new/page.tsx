...
import { ChevronLeft, Plus, Music, X, Search, Check, Save, Image as ImageIcon } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black pb-24">
      ...
      <main className="pt-[100px] max-w-7xl mx-auto px-4">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-black">Create New Bundle</h1>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div>
                  <h3 className="text-xl font-bold">Select Beats</h3>
