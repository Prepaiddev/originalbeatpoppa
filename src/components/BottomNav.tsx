...
export default function BottomNav() {
  ...
  const navItems = [
    ...
    { href: '/dashboard/creator/upload', label: 'Create', icon: Plus, isCenter: true },
  ...
  return (
    <>
      ...
      <StatusModal
        ...
        type="error"
        title="Access Denied"
        message="You cannot upload beats as a buyer. Switch to a Creator account to start selling."
      />
    </>
  );
}
